...
public class Calculation {
  ...
  /**
   * Linearly interpolates between 2 double values using the formula f1+(a*(f2-f1)). Any valid
  ...
  /**
   * Clamps a given value between a min and max value, e.g (0, 5, 5.8) would yield 5, (0, 5, -1.3)
   * would yield 0 and (0, 5, 3.2) would yield 3.2
   *
