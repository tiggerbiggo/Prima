        ...
        try {
            ...
            for(int i=0; i<imageFiles.length; i++){
                try {
                    ...
                    System.err.printf("Exception when reading image from file '%s', %s", imageFiles[i].toString(), e.toString());
                    return null;
                }
            }
            return toReturn;
            ...
            System.err.println("Error in FileManager.getImgsFromFolder: Access was denied to directory \"" + dirName + "\"");
        }
        return null;
    }
}
