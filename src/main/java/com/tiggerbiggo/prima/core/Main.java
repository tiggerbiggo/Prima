...
public class Main
{
    ...
    public static void doImage(String imageName, String outName, Gradient g, int scaleFactor)
    {
        ...
        MapGenFragment gen = new MapGenFragment(new Vector2(0), new Vector2(1));
        //TransformFragment t = new TransformFragment(gen, Transform.TANNY);
        //CombineFragment combine = new CombineFragment(t, new ConstFragment(new Vector2(1)), CombineType.ADD);
