...
public abstract class VectorArrayOutputLink extends OutputLink<Vector2[]> {
  public VectorArrayOutputLink(String desc){
    this.desc = desc;
  }
  @Override
  ...
  public Color[] getColors(RenderParams p) {
    return ColorTools.colorArray(p.frameNum(), SimpleGradient.evaluate(get(p.asSingleFrame())[0], Color.black, Color.white, true));
  }
